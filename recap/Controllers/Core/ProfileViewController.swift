...
class ProfileViewController: UIViewController {
    ...
    // Add a variable to hold prefetched citations
    ...
    override func viewDidLoad() {
        ...
        setupTableView()
        prefetchQuestions()
        prefetchCitations()  // Add citation prefetching
    }
...
extension ProfileViewController: UITableViewDelegate, UITableViewDataSource {
    func numberOfSections(in tableView: UITableView) -> Int {
        return 4  // Personal Information, Health, Medical Information, and Account Management
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case 0: return 6
        case 1: return 1
        case 2: return 1  // Medical Citations
        case 3: return 1  // Delete Account option
        default: return 0
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 2:
            cell.textLabel?.text = "Medical Information Citations"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 1 && indexPath.row == 0 {
            ...
            // Pass the prefetched citations if available
            if let prefetchedCitations = self.prefetchedCitations {
    ...
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        ...
        case 2: return "View sources for medical information provided in the app."
        default: return nil
        }
    }
