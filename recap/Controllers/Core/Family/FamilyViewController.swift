...
//            analyticsService = CoreAnalyticsService(verifiedUserDocID: verifiedUserDocID)
//        }
//
//        
...
//
//        
//        let trendsCard = TrendsCardView(frame: CGRect(x: 0, y: 0, width: 200, height: 100), verifiedUserDocID: "hOK9UY6qgeS44tRF6btySWU3e7a2")
//
